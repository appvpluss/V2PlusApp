...
dependencies {
    ...
    implementation(files("C:\\Users\\Rez\\Desktop\\v2rayNG-master\\v2rayNG-master\\libv2ray.aar"))
    implementation(files("C:\\Users\\Rez\\Desktop\\MT\\rxpermissions-0.9.4.aar"))
