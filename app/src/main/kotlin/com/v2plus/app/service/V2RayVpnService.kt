...
import com.v2plus.app.util.MyContextWrapper
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            //stopSelf has to be called ahead of mInterface.close(). otherwise v2plus core cannot be stooped
            //It's strage but true.
            //This can be verified by putting stopself() behind and call stopLoop and startLoop
            //in a row for several times. You will find that later created v2plus core report port in use
            //which means the first v2plus core somehow failed to stop and release the port.
            stopSelf()
