...
> **🔗 این پروژه یک فورک از [V2RayNG](https://github.com/2dust/v2rayNG) است.**
...
## 📡 **منابع کانفیگ‌ها**
- تعداد سرورها بین **۱ تا ۲۰** متغیر است. این تغییر به دلیل **تعویض کانفیگ‌ها** صورت می‌گیرد.
- **تمامی کانفیگ‌ها روی سرور شخصی اجرا می‌شوند** و از کانال‌ها یا منابع دیگر **جمع‌آوری نمی‌شوند**.
